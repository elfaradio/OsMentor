    ...
    return (
        <div style={{ display: 'flex', gap: '0.5rem' }}>
            <div
                ...
                style={{ width: '90px', flexShrink: 0, display: 'flex', alignItems: 'center', gap: '0.35rem', cursor: 'default' }}
            >
                <span>🌍</span>
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                background: `
                    radial-gradient(ellipse 70% 60% at 10% 10%, rgba(6,182,212,0.12) 0%, transparent 55%),
                    radial-gradient(ellipse 60% 50% at 90% 85%, rgba(99,102,241,0.12) 0%, transparent 55%),
                    radial-gradient(ellipse 40% 40% at 55% 45%, rgba(168,85,247,0.06) 0%, transparent 50%)
                `,
            }} />
            ...
            <div className="fade-in" style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
                    <div style={{
                        ...
                        width: '3.25rem', height: '3.25rem', borderRadius: '1rem', marginBottom: '1rem',
                        background: 'linear-gradient(135deg,#0891b2,#6366f1)',
                        boxShadow: '0 0 32px rgba(6,182,212,0.35)',
                    }}>
                        <svg fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2.5} style={{ width: '1.4rem', height: '1.4rem' }}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                        </svg>
                    </div>
                    <h1 style={{ margin: 0, fontSize: '1.375rem', fontWeight: 700, color: '#f1f5f9', letterSpacing: '-0.02em' }}>
                        OSMentor AI
                    </h1>
                    <p style={{ margin: '0.3rem 0 0', fontSize: '0.8125rem', color: '#64748b' }}>
                        Your Operating Systems study companion
                    </p>
                </div>
                ...
                <div style={{
                    ...
                    border: '1px solid rgba(51,65,85,0.4)', borderRadius: '0.625rem',
                    ...
                    {TABS.map((t) => (
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '0.4rem', fontSize: '0.8125rem', fontWeight: 600,
                                transition: 'all 0.2s',
                                background: tab === t ? 'linear-gradient(135deg,#0891b2,#6366f1)' : 'transparent',
                                color: tab === t ? '#fff' : '#64748b',
                                boxShadow: tab === t ? '0 2px 8px rgba(6,182,212,0.25)' : 'none',
                            }}
                        >
                    ...
                    {['email', 'phone'].map((m) => (
                        <button
                            ...
                            style={{
                                ...
                                borderColor: method === m ? 'rgba(6,182,212,0.5)' : 'rgba(51,65,85,0.4)',
                                borderRadius: '0.5rem', cursor: 'pointer',
                                background: method === m ? 'rgba(6,182,212,0.08)' : 'transparent',
                        ...
                        >
                            {m === 'email' ? (
                                <>
                                    <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} style={{ width: '0.875rem', height: '0.875rem' }}>
                ...
                {error && (
                    <div style={{
                        ...
                        <svg style={{ flexShrink: 0, width: '0.875rem', height: '0.875rem' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                {/* ══════════ EMAIL FORM ══════════ */}
                {method === 'email' && (
                    <form id="auth-email-form" onSubmit={handleEmailSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
                        {tab === 'sign-up' && (
                            <div>
                        ...
                        <button
                            ...
                            style={{ width: '100%', padding: '0.65rem', fontSize: '0.875rem', marginTop: '0.25rem' }}
                            disabled={loading}
                        >
                    ...
                    >
                        {phoneStep === 1 ? (
                            <div>
                                ...
                                <p style={{ marginTop: '0.4rem', fontSize: '0.7rem', color: '#475569' }}>
                                    Example: 8801712345678 (Bangladesh +880)
                                </p>
                            </div>
                        ) : (
                            <div>
                                <label className="field-label" htmlFor="auth-otp">Enter OTP</label>
                                <p style={{ fontSize: '0.775rem', color: '#64748b', marginBottom: '0.625rem' }}>
                        ...
                        >
                            {loading ? <Spinner /> : null}
                            {phoneStep === 1 ? 'Send OTP' : 'Verify & Sign In'}
                        </button>
                    </form>
                )}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', margin: '1.25rem 0' }}>
                    <div style={{ flex: 1, height: '1px', background: 'rgba(51,65,85,0.4)' }} />
                    <span style={{ fontSize: '0.7rem', color: '#475569', fontWeight: 500, whiteSpace: 'nowrap' }}>or continue with</span>
                    <div style={{ flex: 1, height: '1px', background: 'rgba(51,65,85,0.4)' }} />
                </div>
                ...
                <button
                    ...
                    style={{
                        ...
                        color: '#e2e8f0', fontSize: '0.8125rem', fontWeight: 600,
                ...
                <p style={{ textAlign: 'center', marginTop: '1.25rem', fontSize: '0.75rem', color: '#475569' }}>
                    ...
                    <button
                        ...
                        style={{ background: 'none', border: 'none', color: '#22d3ee', cursor: 'pointer', fontSize: 'inherit', fontWeight: 600, padding: 0 }}
                    >
